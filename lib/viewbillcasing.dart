...
import 'package:sanjay/feetsmaincasingbill.dart';
import 'package:sanjay/main.dart';
import 'package:intl/intl.dart';
import 'package:sanjay/saveandopenpdf.dart';
import 'package:syncfusion_flutter_pdf/pdf.dart';

class viewbillcasing extends StatelessWidget {
        ...
        body: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('\nCasing : ' + casing.selectedValue,
                  style: TextStyle(fontSize: 20, color: Colors.blue.shade900)),
              Text('Feets' + ' : ' + "${casing.casingfeet}",
                  style: TextStyle(
                    fontSize: 17,
                  )),
              Text('Price Per feet : ' + "${casing.casingprice}",
                  style: TextStyle(
                    fontSize: 17,
                  )),
              Text(
              ...
              Text(
                '\nTotal : ' +
                    "${totalwithout + 4000 + (casing.casingfeet * casing.casingprice)}",
                style: TextStyle(fontSize: 18, color: Colors.red),
              ),
              Padding(
  ...
  Future<void> _generatebill() async {
    ...
    billpage.graphics.drawString('Invoice',
        ...
        bounds: const Rect.fromLTWH(230, 0, 120, 50),
    ...
    feetsbill.draw(
      page: billpage,
      bounds: Rect.fromLTWH(0, 50, billpage.getClientSize().width,
    ...
    bill.dispose();
    saveandopenpdf(bytes, 'bill at $formattedTime on $formattedDate.pdf');
  }
}
