...
import 'package:sanjay/feetscustomerbill.dart';
import 'package:sanjay/main.dart';
import 'package:sanjay/viewbill.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:intl/intl.dart';

class viewbillcustomerdetails extends StatelessWidget {
        ...
        body: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Customer Name : ' + editcustomerdetails.customerName,
                style: TextStyle(fontSize: 19),
              ),
              Text(
                'Contact Number : ' + editcustomerdetails.customerNumber,
                style: TextStyle(fontSize: 19),
              ),
              Text('\n'),
              Text('Estimate\n',
              ...
              DottedLine(),
              Text(
                '\nTotal(Without other charges) : ' + "$totalwithout",
                style: TextStyle(fontSize: 18, color: Colors.red),
              ),
              Text('\nLabour + Transport Charges : 4000',
                  style: TextStyle(
                    fontSize: 17,
                  )),
              Text('\n'),
              ...
              ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => feetscustomerbill()));
                  },
